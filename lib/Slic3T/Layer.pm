...
sub _build_slice_z {
    ...
    if ($self->id == 0) {
	return $Slic3T::_first_layer_height / 2 / $Slic3T::scaling_factor;
    }
    return ($Slic3T::_first_layer_height + (($self->id-1) * $Slic3T::layer_height) + ($Slic3T::layer_height/2))
            / $Slic3T::scaling_factor;  #/
}

# Z used for printing
sub _build_print_z {
    my $self = shift;
    return ($Slic3T::_first_layer_height + ($self->id * $Slic3T::layer_height)) / $Slic3T::scaling_factor;
}

sub _build_height {
    my $self = shift;
    return $self->id == 0 ? $Slic3T::_first_layer_height : $Slic3T::layer_height;
}
